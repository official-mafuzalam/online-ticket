                ...
                <tbody id="my-table-body">
                    ...
                    foreach ($columns as $column) {
                        ...
                        foreach ($seats as $seat) {
                            $ticketQuery = "SELECT ticket_id, name, mobile, gender, station, seat, fare, seller_name, seller_counter FROM sell_ticket_history WHERE coach_id = ? AND seat LIKE ? AND seller_id = '$user_id'";
                            ...
                            while ($ticketRow = $ticketResult->fetch_assoc()) {
                                ...
                                foreach ($seats as $s) {
                                    ...
                                    echo "<td class='font-weight-normal'>" . $ticketRow['seller_counter'] . " | " . $ticketRow['seller_name'] . "</td>";
