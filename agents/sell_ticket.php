...
$sql_sell_ticket = "INSERT INTO sell_ticket_history (`ticket_id`, `coach_no`, `coach_id`, `route`, `date`, `time`, `seat`, `fare`, `discount`, `discount_fare_per_seat`, `total_fare`, `station`, `mobile`, `name`, `gender`, `seller_name`, `seller_id`, `seller_counter` ) 
                    VALUES ('$ticket_id','$coach_no','$coach_id','$route','$date','$time','$seat_list', '$fare', '$discount_fare', '$newFare', '$total_fare', '$station','$mobile','$name','$gender', '$user_name', '$user_id', '$counter_name')";
